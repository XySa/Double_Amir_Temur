...
public:
		...
		static USkeletalMeshComponent* SetupSkeletalMeshComponent(AActor* targetActor, USkeletalMesh* skeletalMesh, const FAvatarMetadata& avatarMetaData, class UAnimBlueprint* animBlueprintInstance);
